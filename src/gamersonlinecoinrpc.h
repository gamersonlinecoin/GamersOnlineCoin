...
#ifndef _GAMERSONLINECOINRPC_H_
#define _GAMERSONLINECOINRPC_H_ 1
...
// gamersonlinecoin RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // gamersonlinecoin is not connected
...
/**
 * gamersonlinecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
