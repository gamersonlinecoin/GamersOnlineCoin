...
#ifndef H_GAMERSONLINECOIN_SCRIPT
#define H_GAMERSONLINECOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CgamersonlinecoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, gamersonlinecoin always counted CHECKMULTISIGs
